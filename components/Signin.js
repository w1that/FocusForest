...
export default function Signin({navigation}) {
  ...
  return <View style={{zIndex:2,backgroundColor:'#fff', width:"70%",height:'60%',justifyContent:'center',alignItems:'center',borderRadius:20, marginBottom:20, borderWidth:1, borderColor:'#aed1a3'}}>
      ...
      <TouchableOpacity onPress={()=>signin(email,password,dispatch, navigation)} style={{width:'80%', backgroundColor:'#5fd43d', justifyContent:'center', alignItems:'center', paddingVertical:10, position:'absolute', bottom:20,borderRadius:50}}>
